$(document).ready(function () {
    ...
    function homePagePortalCall() {
      ...
      $.get(
        ...
        function (productList) {
          ...
          var sectionsHeading =
            document.getElementsByClassName("sectionsHeading");
  
          section1Heading.appendChild(
            document.createTextNode("Clothing for Men and Women")
          );
          section2Heading.appendChild(
            document.createTextNode("Accessories for Men and Women")
          );
    ...
    function callProductPortal(productData) {
      ...
      var leftSideWrapper =
        document.getElementsByClassName("left-side-wrapper")[0];
      var bigImg = document.createElement("img");
      bigImg.src = productData.preview;
      bigImg.className = "left-side-img";
      leftSideWrapper.appendChild(bigImg);
  
      var previewCardsWrapper = document.getElementsByClassName(
